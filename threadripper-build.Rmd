...
library(benchmarkme)
load("~/R/hardware-for-data-science/data/BLISBLAS_1.RData")
plot(BLISBLAS_1, test_group = "prog")

```

## Bencharm Matrix Calculation
```{r, message=FALSE, warning=FALSE}
library(benchmarkme)
load("~/R/hardware-for-data-science/data/BLISBLAS_1.RData")
plot(BLISBLAS_1, test_group = "matrix_cal")
```

## Bencharm Matrix Functions
```{r, message=FALSE, warning=FALSE}
library(benchmarkme)
load("~/R/hardware-for-data-science/data/BLISBLAS_1.RData")
plot(BLISBLAS_1, test_group = "matrix_fun")
```
